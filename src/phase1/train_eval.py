...
def write_results(
    ...
    for r in results:
        row = {
            ...
            "train_nll_baseline_per_dim": r.train.get("nll_baseline_per_dim"),
            "train_dnll": r.train.get("dnll"),
            "train_dnll_per_dim": r.train.get("dnll_per_dim"),
            "eval_n": r.eval.get("n"),
            "eval_nll": r.eval.get("nll"),
            "eval_nll_per_dim": r.eval.get("nll_per_dim"),
            "eval_nll_baseline": r.eval.get("nll_baseline"),
            "eval_nll_baseline_per_dim": r.eval.get("nll_baseline_per_dim"),
